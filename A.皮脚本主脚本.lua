...
RevenantLib:Notification({
  Text = "小西脚本作者: 小西\u{e000}",
  Duration = 6,
})
wait(1)
RevenantLib:Notification({
  Text = "小西脚本帮助者: yuxinzhen\u{e000}",
  Duration = 6,
})
wait(1)
RevenantLib:Notification({
...
local UILibrary = loadstring(game:HttpGet([[https://raw.githubusercontent.com/xiaopi77/xiaopi77/main/%E7%9A%AE%E8%84%9A%E6%9C%ACUI%E6%BA%90%E7%A0%81.lua]]))():new("小西本-免费版")
...
PlayerInfoSection:Toggle("开/关小西脚本用户名称显示", "Toggle", false, function(enabled)
  ...
  if enabled then
    ...
    while XM do
      ...
      textLabel.Text = "尊贵的小西脚本用户: " .. game.Players.LocalPlayer.DisplayName
...
AuthorInfoSection:Label("小西脚本")
AuthorInfoSection:Label("永不跑路的脚本")
AuthorInfoSection:Label("作者: 小西")
AuthorInfoSection:Label("作者QQ: 2131869117")
AuthorInfoSection:Label("小西脚本QQ主群: 894995244")
AuthorInfoSection:Label("小西脚本QQ副群: 1002100032")
AuthorInfoSection:Label("小西脚本QQ二群: 746849372")
AuthorInfoSection:Label("小西脚本QQ三群: 571553667")
AuthorInfoSection:Label("小西脚本QQ四群: 609250910")
